...
class Cisne: DesenhosTangram {
    func paint (tangram : Tangram){
        ...
        tangram.cian.center.y = tangram.amarelo.center.y + tangram.cian.frame.height * 0.165
        
        //tangram.laranja
        tangram.laranja.prepare(scale, rotate: 90)
        tangram.laranja.center.x = tangram.cian.center.x + tangram.laranja.frame.width * 0.325
        tangram.laranja.center.y = tangram.verde.center.y + tangram.laranja.frame.height * 0.295
